...
describe("logging.config", function()
  ...
  describe("update()", function()
    ...
    it("ignores non-table input", function()
      ...
      local conf = config.get()
      assert.are.equal(original.level, conf.level)
    end)
  end)
  ...
  describe("set_log_file()", function()
    ...
    it("ignores invalid input", function()
      local original = config.get_log_file()

      config.set_log_file(nil)
      assert.are.equal(original, config.get_log_file())
  ...
  describe("set_level()", function()
    ...
    it("ignores invalid input", function()
      local original = config.get_level()

      config.set_level("invalid")
      assert.are.equal(original, config.get_level())
  ...
  describe("set_strategy()", function()
    ...
    it("ignores invalid strategies", function()
      local original = config.get_strategy()

      config.set_strategy("invalid")
      assert.are.equal(original, config.get_strategy())
