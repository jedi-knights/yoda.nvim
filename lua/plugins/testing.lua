    ...
    config = function()
      ...
      if python_ok then
        ...
        if adapter_ok then
          ...
          vim.notify(
            "[neotest] Python adapter setup failed: "
              .. tostring(adapter_or_err),
            vim.log.levels.WARN
          )
        end
      else
      ...
      if jest_ok then
        ...
        if adapter_ok then
          ...
          vim.notify(
            "[neotest] Jest adapter setup failed: " .. tostring(adapter_or_err),
            vim.log.levels.WARN
          )
        end
      else
      ...
      if go_ok then
        ...
        if adapter_ok then
          ...
          vim.notify(
            "[neotest] Go adapter setup failed: " .. tostring(adapter_or_err),
            vim.log.levels.WARN
          )
        end
      else
      ...
      if not setup_ok then
        vim.notify(
          "[neotest] setup failed: " .. tostring(setup_err),
