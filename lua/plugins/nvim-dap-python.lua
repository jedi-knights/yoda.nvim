...
-- Python DAP adapter. Split out of plugins/nvim-dap.lua in P2 so the language
-- specialization lives with its language rather than in the core file. Moves
-- to extras/lang/python.lua in Phase 2 of the v1.0.0 restructure.
